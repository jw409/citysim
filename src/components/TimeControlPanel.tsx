...
export function TimeControlPanel({ onStart, onPause, onSetSpeed, isInitialized }: TimeControlPanelProps) {
        ...
        <div className="control-group">
          <div style={{
            ...
            background: isInitialized
              ? (state.isRunning ? 'var(--success-color)' : 'var(--warning-color)')
              : 'var(--border-color)',
            borderRadius: '4px',
            color: 'white',
            fontSize: '0.8rem',
